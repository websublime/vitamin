 ...
 */
export function getValueByPath(obj: unknown, path: string, defaultValue = undefined): any {
    const value = path.split('.').reduce((acc, i) => typeof acc !== 'undefined' ? acc[i] : undefined, obj);
...
export function defaultIfUndefined(value: unknown, defaultValue: unknown) {
